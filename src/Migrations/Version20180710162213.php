 ...
 */
class Version20180710162213 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE kid ADD kid_gender_id INT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE kid DROP kid_gender_id');
    }
}
